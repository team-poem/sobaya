...
| `skills/tdd/SKILL.md` | The four rules every test obeys (isolated, setup only in the section header, evident data, readable and specific over short), the audit of an app's existing tests, Phase 0, and the loop guards. Only what AGENTS.md lacks |
